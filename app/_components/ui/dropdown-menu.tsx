...
>(({ className, inset, children, ...props }, ref) => (
  ...
  >
    {children}
    <ChevronRight className="ml-auto h-4 w-4 theme-t-n" />
  </DropdownMenuPrimitive.SubTrigger>
));
DropdownMenuSubTrigger.displayName = DropdownMenuPrimitive.SubTrigger.displayName;

const DropdownMenuSubTriggerWithoutArrow = React.forwardRef<
  React.ElementRef<typeof DropdownMenuPrimitive.SubTrigger>,
  React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.SubTrigger> & {
    inset?: boolean;
  }
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm theme-t-p outline-none",
      // Background
      'focus:bg-base-50 data-[state=open]:bg-base-50 dark:focus:bg-theme-night-background-secondary dark:data-[state=open]:bg-theme-night-background-secondary',
      inset && "pl-8",
      className,
...
DropdownMenuSubTriggerWithoutArrow.displayName = DropdownMenuPrimitive.SubTrigger.displayName;
...
>(({ className, inset, href, ...props }, ref) => (
  <Link href={href}>
    <DropdownMenuPrimitive.Item
      ref={ref}
      className={cn(
        "relative flex cursor-pointer select-none items-center rounded-sm px-2 py-1.5 text-sm theme-t-p outline-none",
        // Background
        'focus:bg-base-50 data-[state=open]:bg-base-50 dark:focus:bg-theme-night-background-secondary dark:data-[state=open]:bg-theme-night-background-secondary',
        inset && "pl-8",
        className,
...
DropdownMenuItemEmpty.displayName = DropdownMenuPrimitive.Item.displayName;
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      "p-2 text-xs font-medium theme-t-n",
      inset && "pl-8",
      className,
    )}
    {...props}
